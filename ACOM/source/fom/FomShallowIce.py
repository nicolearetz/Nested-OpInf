...
import numpy as np
import torch
from methods.timestepping import semi_implicit_euler
...
class FomShallowIce(FomTime):
    ...
    def solve_here(self, **kwargs):
        ...
        c, gamma = self.decompose_parameter(para=para)
        ...
        return semi_implicit_euler(grid_t, A, u0, fct_explicit, M=self.M)
